...
The number of badges and the height which trigger the scroll bar apparition can be changed at the beginning of the script (they will be reset in case of update).
